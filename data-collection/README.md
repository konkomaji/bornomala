...
| `ocr_ground_truth` | Page image -> transcript | `category` matches spec 10.5's benchmark categories exactly (`letterpress_1880_1950` is the category no other model has been trained on); `era` (optional) records composition era separately from scan/print condition - see below; double-annotation fields for the 10% inter-annotator-agreement sample spec 10.3 requires |
